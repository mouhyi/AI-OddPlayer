...
public class AutomatedTester {
	...
	public static void main (String[] args){
		...
		for (int i = 0; i < numberOfGames; i++){
			...
			clients.add(new Thread(new Client(new /* insert 1st AI class here */(), DEFAULT_HOST, DEFAULT_PORT)));
			clients.add(new Thread(new Client(new /* insert 2nd AI class here */(), DEFAULT_HOST, DEFAULT_PORT)));
